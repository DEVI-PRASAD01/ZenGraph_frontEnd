...
class SubscriptionActivity : AppCompatActivity(), PurchasesUpdatedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Apply strike-through to original price (paintFlags not settable in XML)
        findViewById<android.widget.TextView>(R.id.originalPriceText)
    ...
    private fun querySpecificProduct(
        productId: String,
        productType: String,
        ...
        billingClient.queryProductDetailsAsync(params) { billingResult, productDetailsList ->
            if (billingResult.responseCode == BillingClient.BillingResponseCode.OK) {
                ...
                Log.e(
                    TAG,
                    "Failed to query product details for $productId: ${billingResult.debugMessage}"
                )
                callback(false)
            }
        }
    ...
    private fun launchSubscriptionFlow() {
        if (!billingClient.isReady) {
            ...
            Toast.makeText(this, "Billing service not ready. Please try again.", Toast.LENGTH_SHORT)
                .show()
            return
        }
        ...
        if (productDetails != null) {
            val productDetailsParamsList =
                if (productDetails!!.productType == BillingClient.ProductType.SUBS) {
                    ...
                    Log.d(
                        TAG,
                        "Using subscription offer: basePlanId=${selectedOffer.basePlanId}, offerToken=${selectedOffer.offerToken}"
                    )
            ...
            Toast.makeText(
                this,
                "Subscription not available. Please try again.",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
    ...
    override fun onPurchasesUpdated(
        ...
        when (billingResult.responseCode) {
            ...
            BillingClient.BillingResponseCode.ITEM_ALREADY_OWNED -> {
                ...
                Toast.makeText(this, "You already have an active subscription", Toast.LENGTH_SHORT)
                    .show()
                navigateToMain()
            }
            ...
            BillingClient.BillingResponseCode.ITEM_UNAVAILABLE -> {
                ...
                Toast.makeText(
                    this,
                    "Subscription unavailable. Please download app from Play Store for testing.",
                    Toast.LENGTH_LONG
                ).show()
            }
            ...
            BillingClient.BillingResponseCode.DEVELOPER_ERROR -> {
                ...
                Toast.makeText(
                    this,
                    "Configuration error. Check Play Console setup.",
                    Toast.LENGTH_LONG
                ).show()
            }
            ...
            BillingClient.BillingResponseCode.SERVICE_UNAVAILABLE -> {
                ...
                Toast.makeText(
                    this,
                    "Google Play services unavailable. Try again later.",
                    Toast.LENGTH_SHORT
                ).show()
            }
                ...
                Toast.makeText(
                    this,
                    "Purchase failed: ${getResponseCodeMessage(billingResult.responseCode)}",
                    Toast.LENGTH_LONG
                ).show()
            }
        }
    ...
    private fun onSubscriptionSuccess() {
        runOnUiThread {
            Toast.makeText(this, "Subscription successful! Welcome to Premium!", Toast.LENGTH_LONG)
                .show()
        }
